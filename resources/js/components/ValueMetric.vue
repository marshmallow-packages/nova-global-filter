...
export default {
  ...
  mixins: [InteractsWithDates, MetricBehavior, FilterBehavior],
  ...
  methods: {
    ...
    fetch() {
      ...
      minimum(Nova.request().get(this.metricEndpoint, this.filterPayload())).then(this.handleFetchCallback());
    },

    handleFetchCallback() {
      return ({
        data: {
          value: { copyable, value, previous, prefix, suffix, suffixInflection, format, tooltipFormat, zeroResult },
        },
      }) => {
